...
# @app.route("/ingredients/delete/<string:id>", methods=['DELETE'])
# def delete(id):    
...
# @app.route("/ingredients/provide", methods=['PUT'])
# def provide():
...
# @app.route('/ingredients/gethistory/<string:id>/<string:fromDate>/<string:toDate>', methods=['GET'])
